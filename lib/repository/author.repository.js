...
async function writeAuthor(author) {
    const query = `INSERT INTO author(first_name, last_name, email, phone) VALUES('${author.first_name}','${author.last_name}','${author.email}','${author.phone}')`
...
async function updateAuthor(id, author) {
    const query = `UPDATE author SET first_name='${author.first_name}', last_name='${author.last_name}', email='${author.email}', phone='${author.phone}' WHERE id=${id}`

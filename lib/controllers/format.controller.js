...
async function getAllFormats(req, res, next) {
    try {
        const formatsList = await formatService.getAllFormats()
...
async function createNewFormat(req, res, next) {
    try {
        ...
        const format = await formatService.createNewFormat(req.body)
...
async function updateFormat(req, res, next) {
    try {
        ...
        const format = await formatService.updateFormat(id, req.body)

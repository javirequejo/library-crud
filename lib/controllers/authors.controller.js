...
const authorValidationStructure = {
    "firstName": primitiveValidators.string,
    "lastName": primitiveValidators.string,
...
async function getAllAuthors(req, res, next) {
    try {
        const authorsList = await authorsService.getAllAuthors()
...
async function createNewAuthor(req, res, next) {
    try {
        ...
        const author = await authorsService.createNewAuthor(req.body)
